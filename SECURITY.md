...
Instead please use this [Report a Vulnerability](https://github.com/solana-program/token/security/advisories/new) link.
...
Only the `spl-token` program is included in the bounty scope, at
[program](https://github.com/solana-program/token/tree/master/program).
