...
impl<'a> TokenInstruction<'a> {
    ...
    fn unpack_amount_decimals(input: &[u8]) -> Result<(U256, u8, &[u8]), ProgramError> {
...
mod test {
    ...
    fn test_instruction_packing() {
        ...
        let check = TokenInstruction::Transfer {
            amount: U256::new(1),
        };
        let packed = check.pack();
        let expect = Vec::from([
        ...
        let check = TokenInstruction::Approve {
            amount: U256::new(1),
        };
        let packed = check.pack();
        let expect = Vec::from([
        ...
        let check = TokenInstruction::MintTo {
            amount: U256::new(1),
        };
        let packed = check.pack();
        let expect = Vec::from([
        ...
        let check = TokenInstruction::Burn {
            amount: U256::new(1),
        };
        let packed = check.pack();
        let expect = Vec::from([
        ...
        let check = TokenInstruction::AmountToUiAmount {
            amount: U256::new(42),
        };
        let packed = check.pack();
        let expect = vec![
